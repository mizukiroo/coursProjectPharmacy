...
<footer class="siteFooter herb-footer">
    <div class="container herb-footer-grid">
        <div class="herb-footer-brand">
            <div>
                ...
                <div class="herb-footer-subtitle">
                    Бронирование льготных лекарств в социальных аптеках.
                </div>
            </div>
        </div>

        <div class="herb-footer-col">
            <div class="herb-footer-head">Навигация</div>
            <a href="index.php">Главная</a>
            <a href="howto.php">Как получить услугу</a>
            <a href="map.php">Карта аптек</a>
        </div>
        ...
        <div class="herb-footer-col">
            <div class="herb-footer-head">Поддержка</div>
            <p>Если у вас возникли вопросы по бронированию лекарств, обратитесь в свою поликлинику или социальную аптеку.</p>
        </div>
    </div>
